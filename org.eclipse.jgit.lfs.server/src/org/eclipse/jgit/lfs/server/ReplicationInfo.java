...
public class ReplicationInfo {
     ...
     * @param repositoryId UUID of repository
     * @param replicationGroupId UUID of replication group managing repository
     * @param isReplica Whether the repository is replicated
     */
    public ReplicationInfo(
