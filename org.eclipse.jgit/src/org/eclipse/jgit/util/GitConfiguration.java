...
public final class GitConfiguration {
     ...
     *
     * @param core Config section name
     * @param subsection Config subsection name, if required
     * @param gitmsconfig Config key
     ...
     * @param subsection Config subsection, if required
     * @param name Config entry name
     * @param defaultName Default value
     ...
     * outdated ( stale ).
     *
     * @throws IOException If git config could not be found
     * @throws ConfigInvalidException If git config was invalid
     */
